 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.spritecloud.com/test-automation. v0.59 — depth parity:
...
test.describe('spriteCloud — keyboard navigation @ https://www.spritecloud.com/test-automation', () => {
  test('@kind:keyboard @smoke Tab cycles through up to 10 focusable elements', async ({ page }) => {
  ...
  test('@kind:keyboard @no-trap Tab from the last focusable either wraps to the first or exits the page', async ({ page }) => {
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/test-automation', () => {
  test('@kind:keyboard @smoke navigate with Tab through the first 10 focusable elements', async ({ page }) => {
    await page.goto('/test-automation')
  ...
  test('@kind:keyboard @no-trap Pressing Tab after the last focusable either wraps to the first or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/test-automation')
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/test-automation', () => {
  ...
  test('@kind:keyboard @focus-indicator first tabbed-to element has a visible focus indicator', async ({ page }) => {
    await page.goto('/test-automation')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard @no-trap Tab from the last interactive element wraps or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/test-automation')
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/test-automation', () => {
  ...
  test('@kind:keyboard @no-trap Tabbing past the last focusable wraps focus or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/test-automation')
