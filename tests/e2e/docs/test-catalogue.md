...
| `tests/e2e/features/research-case-study-giftshift.feature` | `research` | `standard` | 2 |
...
#### `research` — `tests/e2e/features/research-case-study-giftshift.feature`

Priority: `standard`. 2 step(s).

1. `https://www.spritecloud.com/` — _QA & Software Testing Consultancy — spriteCloud_
2. clicked `/case-study/giftshift` → `https://www.spritecloud.com/case-study/giftshift` — _GiftShift — Case Study — spriteCloud_
