 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/functional-testing. v0.59 — depth
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:a11y-landmarks @smoke Exactly one <main>, one <h1>, and at least one <nav> region', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks @heading-hierarchy Headings follow a sequential hierarchy (e.g., no h1→h3 skips)', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks @skip-link A visible or keyboard-accessible "skip to content" link is present (WCAG 2.4.1)', async ({ page }) => {
    // The first focusable should either be a skip link OR there must
    // be an in-page anchor to #main / #content / [role=main]. WCAG
    // 2.4.1 ("Bypass Blocks") requires it for keyboard / SR users.
    await page.goto('/functional-testing')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:a11y-landmarks single main, h1, and at least one nav region exist', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks no focusable elements appear inside aria-hidden regions', async ({ page }) => {
    await page.goto('/functional-testing')
    const hiddenFocusables = await page.locator('[aria-hidden="true"]').locator('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])').count()
    expect.soft(hiddenFocusables, `${hiddenFocusables} focusable elements inside aria-hidden — confusing for screen readers`).toBe(0)
  })

  test('@kind:a11y-landmarks headings follow sequential order (no skipped levels)', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks duplicate landmarks each have an accessible name', async ({ page }) => {
    // When ≥2 navs / asides / sections exist, each must carry an
    // accessible name (aria-label, aria-labelledby, or an inner
    // <h2-6>) so screen-reader users can distinguish them.
    await page.goto('/functional-testing')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility landmark structure tests', () => {
  test('@kind:a11y-landmarks smoke check: exactly one main, h1, and at least one nav', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks ensure no focusable elements are inside aria-hidden regions', async ({ page }) => {
    await page.goto('/functional-testing')
    const hiddenFocusables = await page.locator('[aria-hidden="true"]').locator('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])').count()
    expect.soft(hiddenFocusables, `${hiddenFocusables} focusable elements inside aria-hidden — confusing for screen readers`).toBe(0)
  })

  test('@kind:a11y-landmarks verify headings follow sequential level order (no skips)', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks duplicate landmarks must each have a unique accessible name', async ({ page }) => {
    // When ≥2 navs / asides / sections exist, each must carry an
    // accessible name (aria-label, aria-labelledby, or an inner
    // <h2-6>) so screen-reader users can distinguish them.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks confirm “skip to content” link or equivalent is present (WCAG 2.4.1)', async ({ page }) => {
    // The first focusable should either be a skip link OR there must
    // be an in-page anchor to #main / #content / [role=main]. WCAG
    // 2.4.1 ("Bypass Blocks") requires it for keyboard / SR users.
    await page.goto('/functional-testing')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:a11y-landmarks smoke test: single main, single h1, at least one nav', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks heading levels must increase by at most one at a time', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y-landmarks repeat landmarks must specify accessible names', async ({ page }) => {
    // When ≥2 navs / asides / sections exist, each must carry an
    // accessible name (aria-label, aria-labelledby, or an inner
    // <h2-6>) so screen-reader users can distinguish them.
    await page.goto('/functional-testing')
