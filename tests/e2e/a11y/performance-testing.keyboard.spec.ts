...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/performance-testing', () => {
  test('@kind:keyboard @smoke Tab through first 10 focusables', async ({ page }) => {
    await page.goto('/performance-testing')
  ...
  test('@kind:keyboard @focus-indicator First focused element has visible focus indicator', async ({ page }) => {
    await page.goto('/performance-testing')
    await page.keyboard.press('Tab')
