 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/case-studies/ben-nl. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/case-studies/ben-nl', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-studies/ben-nl')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-studies/ben-nl', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-studies/ben-nl', { waitUntil: 'domcontentloaded' })
