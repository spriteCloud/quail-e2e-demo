 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/vacancy/hr-internship. v0.59 — depth
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/vacancy/hr-internship', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/vacancy/hr-internship', { waitUntil: 'domcontentloaded' })
