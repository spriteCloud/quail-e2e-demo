 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/case-studies/citizenm. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/case-studies/citizenm', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-studies/citizenm')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-studies/citizenm', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-studies/citizenm', { waitUntil: 'domcontentloaded' })
