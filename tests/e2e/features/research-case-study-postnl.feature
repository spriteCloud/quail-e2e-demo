...
Feature: Spritecloud — research journey
  ...
  Scenario: research journey reaches its terminal page
    ...
    When I navigate directly to "/case-study/postnl"
    Then I see the heading "One test framework for seven PostNL teams"
    And the page title contains "PostNL — Case Study — spriteCloud"
