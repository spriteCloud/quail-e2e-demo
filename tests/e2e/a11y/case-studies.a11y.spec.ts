 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/case-studies. v0.59 — depth parity: five
...
test.describe('spriteCloud — accessibility @ https://www.spritecloud.com/case-studies', () => {
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility on case-studies page', () => {
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility for case-studies page', () => {
  ...
  test('@kind:a11y color contrast meets WCAG 2.1 AA thresholds', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/case-studies')
  ...
  test('@kind:a11y ARIA attribute usage is correct', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/case-studies')
