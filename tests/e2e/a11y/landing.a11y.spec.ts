 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/. v0.59 — depth parity: five
...
test.describe('spriteCloud accessibility checks on https://www.spritecloud.com/', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA compliance check', async ({ page }) => {
  ...
  test('@kind:a11y ARIA attribute discipline (valid attrs, required children)', async ({ page }) => {
...
test.describe('Spritecloud — accessibility checks on https://www.spritecloud.com/', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA-only profiling', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/', () => {
  ...
  test('@kind:a11y @wcag-aa complies with WCAG 2.1 AA requirements', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/')
  ...
  test('@kind:a11y @color-contrast color contrast meets WCAG 2.1 AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/')
  ...
  test('@kind:a11y @aria-attrs ARIA attributes are used correctly', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/')
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/', () => {
  ...
  test('@kind:a11y @wcag-aa meets WCAG 2.1 AA compliance', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/')
  ...
  test('@kind:a11y @color-contrast color contrast passes WCAG AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility checks on www.spritecloud.com', () => {
  test('@kind:a11y @smoke no serious or critical axe violations', async ({ page }) => {
    await page.goto('/')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliance profile', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility checks for https://www.spritecloud.com/', () => {
