 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/transforming-software-testing-a-guide-to-popular-ai-testing-tools', { waitUntil: 'domcontentloaded' })
