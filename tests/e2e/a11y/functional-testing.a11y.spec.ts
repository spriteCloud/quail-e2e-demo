 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/functional-testing. v0.59 — depth parity: five
...
test.describe('spriteCloud accessibility checks on functional-testing page', () => {
  ...
  test('wcag-aa test: no WCAG 2.1 AA violations', async ({ page }) => {
  ...
  test('color-contrast test: all text contrast meets AA threshold', async ({ page }) => {
  ...
  test('aria-attrs test: no ARIA attribute violations', async ({ page }) => {
  ...
  test('form-labels test: all form inputs have accessible labels', async ({ page }) => {
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:a11y @smoke no serious or critical accessibility violations', async ({ page }) => {
    await page.goto('/functional-testing')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('@kind:a11y @wcag-aa compliance with WCAG 2.1 AA requirements', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @color-contrast color contrast ratio passes WCAG AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @aria-attrs correct usage of ARIA attributes', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @form-labels all form inputs are properly labeled', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/functional-testing')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility checks', () => {
  test('smoke: no serious or critical failures', async ({ page }) => {
    await page.goto('/functional-testing')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('wcag-aa: only WCAG 2.1 AA violations', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/functional-testing')
  ...
  test('color-contrast: meets AA contrast threshold', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/functional-testing')
  ...
  test('aria-attrs: no ARIA attribute issues', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/functional-testing')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility on functional testing page', () => {
  test('@kind:a11y @smoke no serious or critical accessibility violations', async ({ page }) => {
    await page.goto('/functional-testing')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliance only', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @color-contrast color contrast meets WCAG AA minimum', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @aria-attrs ARIA attributes used correctly', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/functional-testing')
...
test.describe('Spritecloud — accessibility checks on functional-testing page', () => {
  ...
  test('@kind:a11y @wcag-aa — only WCAG 2.1 AA violations', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @color-contrast — color contrast meets AA threshold', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @aria-attrs — proper use of ARIA attributes', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y @form-labels — all form inputs have labels', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/functional-testing')
...
test.describe('Spritecloud accessibility checks on functional testing page', () => {
  ...
  test('@kind:a11y WCAG 2.1 AA compliance gate', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y color contrast checks meet AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y ARIA attribute correctness', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/functional-testing')
  ...
  test('@kind:a11y form inputs have programmatic labels', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/functional-testing')
