 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/vacancy/test-automation-engineer. v0.59 — depth
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/vacancy/test-automation-engineer', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/vacancy/test-automation-engineer', { waitUntil: 'domcontentloaded' })
