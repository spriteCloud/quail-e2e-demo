 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/case-study/ben-nl. v0.59 — depth
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-study/ben-nl', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-study/ben-nl', { waitUntil: 'domcontentloaded' })
