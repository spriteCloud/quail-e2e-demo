 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/image-patching-with-copacetic. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/image-patching-with-copacetic', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/image-patching-with-copacetic')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/image-patching-with-copacetic', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/image-patching-with-copacetic', { waitUntil: 'domcontentloaded' })
