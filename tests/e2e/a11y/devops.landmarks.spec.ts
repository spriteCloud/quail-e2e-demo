 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/devops. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/devops', () => {
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/devops', () => {
  test('@kind:a11y-landmarks single main, h1, and nav region present', async ({ page }) => {
    await page.goto('/devops')
  ...
  test('@kind:a11y-landmarks headings follow sequential order without skips', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/devops')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/devops', () => {
  test('@kind:a11y-landmarks single main, h1, and nav regions present', async ({ page }) => {
    await page.goto('/devops')
  ...
  test('@kind:a11y-landmarks headings follow sequential hierarchy (no skips)', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/devops')
  ...
  test('@kind:a11y-landmarks duplicate landmarks have accessible names', async ({ page }) => {
    // When ≥2 navs / asides / sections exist, each must carry an
    // accessible name (aria-label, aria-labelledby, or an inner
    // <h2-6>) so screen-reader users can distinguish them.
    await page.goto('/devops')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility landmark checks for /devops', () => {
  ...
  test('@kind:a11y-landmarks Headings follow sequential order (no skipping levels)', async ({ page }) => {
    // Walk every heading in source order. A jump from h1 to h3 (skipping
    // h2) breaks screen-reader navigation. h2 to h4 is the same bug at
    // the next level.
    await page.goto('/devops')
