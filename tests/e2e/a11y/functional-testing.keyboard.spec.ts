 ...
 * Generated by quail.
 *
 * Keyboard-only navigation for https://www.spritecloud.com/functional-testing. v0.59 — depth parity:
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  ...
  test('@kind:keyboard @no-trap Pressing Tab from the last focusable wraps focus or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/functional-testing')
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes a visible modal/dialog and returns focus', async ({ page }) => {
    await page.goto('/functional-testing')
    // Find a candidate dialog or modal trigger; skip if absent.
    const trigger = page.locator('[aria-haspopup="dialog"], [data-modal-trigger], [aria-controls][aria-expanded]').first()
    if (await trigger.count() === 0) test.skip()
  ...
  test('@kind:keyboard @no-trap Tab past the last focusable wraps focus or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/functional-testing')
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  ...
  test('@kind:keyboard @escape-dismiss Escape closes the visible dialog and returns focus', async ({ page }) => {
    await page.goto('/functional-testing')
    // Find a candidate dialog or modal trigger; skip if absent.
    const trigger = page.locator('[aria-haspopup="dialog"], [data-modal-trigger], [aria-controls][aria-expanded]').first()
    if (await trigger.count() === 0) test.skip()
  ...
  test('@kind:keyboard @no-trap Tab from the last focusable wraps around or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/functional-testing')
...
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  ...
  test('@kind:keyboard @enter-space Enter activates links and buttons when focused', async ({ page }) => {
    await page.goto('/functional-testing')
    // Find the first interactive control of each type.
    const link = page.locator('a[href]:not([href^="#"]):not([href^="mailto:"]):not([href^="tel:"])').first()
    if (await link.count() === 0) test.skip()
  ...
  test('@kind:keyboard @no-trap Tab from the last focusable wraps or exits navigation', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/functional-testing')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:keyboard tabs through the first 10 focusable elements', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:keyboard the first focused element shows a visible focus indicator', async ({ page }) => {
    await page.goto('/functional-testing')
    await page.keyboard.press('Tab')
  ...
  test('@kind:keyboard pressing Escape closes a visible dialog and restores focus', async ({ page }) => {
    await page.goto('/functional-testing')
    // Find a candidate dialog or modal trigger; skip if absent.
    const trigger = page.locator('[aria-haspopup="dialog"], [data-modal-trigger], [aria-controls][aria-expanded]').first()
    if (await trigger.count() === 0) test.skip()
  ...
  test('@kind:keyboard Enter activates focused links or buttons', async ({ page }) => {
    await page.goto('/functional-testing')
    // Find the first interactive control of each type.
    const link = page.locator('a[href]:not([href^="#"]):not([href^="mailto:"]):not([href^="tel:"])').first()
    if (await link.count() === 0) test.skip()
  ...
  test('@kind:keyboard Tabbing past the last focusable wraps or exits the page', async ({ page }) => {
    // Find the last focusable; Tab once more; confirm focus moved
    // OR landed back on the first focusable (wrap). What we forbid
    // is staying on the same element (a focus trap outside a modal).
    await page.goto('/functional-testing')
