 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/test-automation. v0.59 — depth parity: five
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/test-automation', () => {
  test('@kind:a11y @smoke no serious or critical accessibility violations found', async ({ page }) => {
    await page.goto('/test-automation')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliance checked', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/test-automation')
  ...
  test('@kind:a11y @color-contrast color contrast meets WCAG AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/test-automation')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility checks on test-automation page', () => {
  ...
  test('meets WCAG 2.1 AA-only requirements', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/test-automation')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility on test automation page', () => {
  test('@kind:a11y @smoke — no serious or critical axe-core violations', async ({ page }) => {
    await page.goto('/test-automation')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('@kind:a11y @wcag-aa — WCAG 2.1 AA-only profile check', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/test-automation')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/test-automation', () => {
  test('@kind:a11y @smoke no serious or critical axe violations (WCAG 2a/2aa/21a/21aa)', async ({ page }) => {
    await page.goto('/test-automation')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliancegate', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/test-automation')
  ...
  test('@kind:a11y @color-contrast color contrast passes AA threshold', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/test-automation')
