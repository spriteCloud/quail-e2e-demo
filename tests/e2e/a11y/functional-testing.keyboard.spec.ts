...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — keyboard navigation @ https://www.spritecloud.com/functional-testing', () => {
  test('@kind:keyboard @smoke navigates through the first 10 focusable elements with Tab', async ({ page }) => {
    await page.goto('/functional-testing')
  ...
  test('@kind:keyboard @focus-indicator the first tab-target has a visible focus indicator', async ({ page }) => {
    await page.goto('/functional-testing')
    await page.keyboard.press('Tab')
