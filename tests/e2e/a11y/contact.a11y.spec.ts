 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/contact. v0.59 — depth parity: five
...
test.describe('SpriteCloud contact page accessibility checks', () => {
  ...
  test('@kind:a11y color-contrast — color contrast meets WCAG AA', async ({ page }) => {
  ...
  test('@kind:a11y aria-attrs — proper ARIA attribute usage', async ({ page }) => {
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud contact page accessibility', () => {
  ...
  test('@kind:a11y @wcag-aa WCAG 2.1 AA compliance', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/contact')
  ...
  test('@kind:a11y @color-contrast color contrast passes AA standards', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/contact')
  ...
  test('@kind:a11y @aria-attrs ARIA attribute validation', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/contact')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud contact page accessibility', () => {
  test('smoke: no serious or critical WCAG violations', async ({ page }) => {
    await page.goto('/contact')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('wcag-aa: compliant with WCAG 2.1 AA', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/contact')
  ...
  test('color-contrast: meets AA contrast requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/contact')
  ...
  test('aria-attrs: no invalid or misused ARIA attributes', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/contact')
  ...
  test('form-labels: all form inputs have accessible labels', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/contact')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/contact', () => {
  test('@kind:a11y @smoke no serious or critical accessibility violations', async ({ page }) => {
    await page.goto('/contact')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
  ...
  test('@kind:a11y @color-contrast meets WCAG 2.1 AA color contrast requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/contact')
  ...
  test('@kind:a11y @aria-attrs valid ARIA attributes and roles', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/contact')
...
test.describe('Spritecloud contact page accessibility', () => {
  ...
  test('@kind:a11y @wcag-aa verify WCAG 2.1 AA compliance', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/contact')
  ...
  test('@kind:a11y @color-contrast verify contrast meets WCAG AA standards', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/contact')
  ...
  test('@kind:a11y @aria-attrs validate ARIA attribute usage', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/contact')
  ...
  test('@kind:a11y @form-labels confirm all form inputs have labels', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/contact')
