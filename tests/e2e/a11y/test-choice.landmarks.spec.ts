 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/test-choice. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/test-choice', () => {
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/test-choice', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/test-choice', { waitUntil: 'domcontentloaded' })
