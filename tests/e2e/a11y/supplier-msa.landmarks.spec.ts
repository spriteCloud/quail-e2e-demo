 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/supplier-msa. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/supplier-msa', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/supplier-msa')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/supplier-msa', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/supplier-msa', { waitUntil: 'domcontentloaded' })
