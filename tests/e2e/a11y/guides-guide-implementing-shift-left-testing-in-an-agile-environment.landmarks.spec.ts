 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/guide-implementing-shift-left-testing-in-an-agile-environment. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/guide-implementing-shift-left-testing-in-an-agile-environment', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/guide-implementing-shift-left-testing-in-an-agile-environment')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/guide-implementing-shift-left-testing-in-an-agile-environment', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/guide-implementing-shift-left-testing-in-an-agile-environment', { waitUntil: 'domcontentloaded' })
