 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/case-study-ecomm-platform. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/case-study-ecomm-platform', () => {
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/case-study-ecomm-platform', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/case-study-ecomm-platform', { waitUntil: 'domcontentloaded' })
