 ...
 *   - this file (*.api.spec.ts): "POST https://www.spritecloud.com/careers still accepts our shape"
 *
 * Endpoint:     https://www.spritecloud.com/careers
 * Method:       get
...
test.describe('Spritecloud — API contract @ https://www.spritecloud.com/careers', () => {

  test('@kind:api @smoke happy: realistic body returns 2xx', async ({ request }) => {
    const response = await request.get('https://www.spritecloud.com/careers', {
      form: {
  ...
  test('@kind:api @negative rapid burst stays healthy or is rate-limited', async ({ request }) => {
    ...
    const responses = await Promise.all(
      Array.from({ length: 10 }, () => request.get('https://www.spritecloud.com/careers', { form: body }))
    )
