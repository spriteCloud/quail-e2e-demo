 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/robot-framework-guide. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/robot-framework-guide', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/robot-framework-guide')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/robot-framework-guide', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/robot-framework-guide', { waitUntil: 'domcontentloaded' })
