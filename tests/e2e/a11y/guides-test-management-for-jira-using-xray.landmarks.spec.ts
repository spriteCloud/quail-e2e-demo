 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/test-management-for-jira-using-xray. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/test-management-for-jira-using-xray', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/test-management-for-jira-using-xray')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/test-management-for-jira-using-xray', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/test-management-for-jira-using-xray', { waitUntil: 'domcontentloaded' })
