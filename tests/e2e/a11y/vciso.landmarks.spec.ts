 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/vciso. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/vciso', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/vciso')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/vciso', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/vciso', { waitUntil: 'domcontentloaded' })
