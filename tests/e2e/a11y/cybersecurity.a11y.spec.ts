 ...
 * Generated by quail.
 *
 * Accessibility check for https://www.spritecloud.com/cybersecurity. v0.59 — depth parity: five
...
test.describe('spriteCloud — accessibility @ https://www.spritecloud.com/cybersecurity', () => {
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility check for cybersecurity page', () => {
  test('@kind:a11y @smoke no serious or critical axe violations', async ({ page }) => {
    await page.goto('/cybersecurity')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility for cybersecurity page', () => {
  ...
  test('@kind:a11y wcag-aa test: only WCAG 2.1 AA violations', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y color-contrast test: all contrast meets AA threshold', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y aria-attrs test: ARIA attributes used correctly', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y form-labels test: all form inputs have labels', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/cybersecurity')
 ...
 *   color-contrast — most-violated WCAG rule deserves its own assertion
 *   aria-attrs    — aria-* rules standalone (valid attr, required children)
 *   form-labels   — passes form input labeling gate
 *
 * Each block uses expect.soft() so the report surfaces all five
 * rather than short-circuiting on the first failure.
 *
...
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/cybersecurity', () => {
  ...
  test('@kind:a11y @wcag-aa passes WCAG 2.1 AA-only gate', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y @color-contrast passes color contrast (AA) gate', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y @aria-attrs passes ARIA attribute checks', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y @form-labels passes form input labeling gate', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/cybersecurity')
 ...
 */
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud accessibility on the cybersecurity page', () => {
  test('no serious or critical accessibility issues found', async ({ page }) => {
    await page.goto('/cybersecurity')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('meets WCAG 2.1 AA compliance', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/cybersecurity')
  ...
  test('text contrast meets WCAG AA requirements', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/cybersecurity')
...
test.describe.configure({ mode: 'parallel' })
test.describe('Spritecloud — accessibility @ https://www.spritecloud.com/cybersecurity', () => {
  test('@kind:a11y no serious or critical axe violations', async ({ page }) => {
    await page.goto('/cybersecurity')
    const results = await new AxeBuilder({ page })
      .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
      .analyze()
  ...
  test('@kind:a11y WCAG 2.1 AA-only profile', async ({ page }) => {
    // Targeted gate: many teams require AA compliance specifically.
    // Running with just the wcag21aa tag lets the report distinguish
    // AA-required failures from A-required ones in a single grep.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y color contrast meets the AA threshold', async ({ page }) => {
    // The single most-violated WCAG rule in production. Worth its own
    // assertion so the report surfaces contrast separately from the
    // rest of the axe bag.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y ARIA attribute discipline', async ({ page }) => {
    // Catch the common ARIA mis-uses (invalid attr names, required
    // children missing, valid roles for elements). Separate gate so
    // teams can distinguish a wiring bug from a visual issue.
    await page.goto('/cybersecurity')
  ...
  test('@kind:a11y every form input has a programmatic label', async ({ page }) => {
    // Cheaper signal than axe for form-heavy pages: walk every input
    // and confirm it has <label for>, aria-label, aria-labelledby, OR
    // a placeholder (placeholder is the weakest acceptable fallback).
    await page.goto('/cybersecurity')
