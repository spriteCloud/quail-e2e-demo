 ...
 * Generated by quail.
 *
 * Accessibility landmark structure for https://www.spritecloud.com/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language. v0.59 — depth
...
test.describe('spriteCloud — a11y landmarks @ https://www.spritecloud.com/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language')
...
test.describe('Spritecloud — a11y landmarks @ https://www.spritecloud.com/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', () => {
  test('@kind:a11y-landmarks @smoke single main + h1 + nav', async ({ page }) => {
    await page.goto('/guides/typescript-its-benefits-use-cases-and-pros-in-testing-as-a-language', { waitUntil: 'domcontentloaded' })
